...
# PAGE SETTINGS
# ----------------------------------------------------------------------------
app_title = 'Arkansas Environmental Education Directory'
page_title = 'Arkansas Environmental Education Directory'
sub_title = 'Filter on'
...
# MAP SETTINGS
# ----------------------------------------------------------------------------
map_center_lat = 34.7449038
map_center_lon = -93.4485126
map_zoom = 5.072
